...
export default function MyDesignDetail() {
    ...
    /*
    useEffect() 내에서 setCurrentData(targetData); 호출 -> currentData가 변경됨 -> useEffect의 Dependency Array인 currentData가 변경되니 다시 useEffect() 수행되고 setCurrentData(..); 호출 -> 무한반복
    ...
    */
    ...
    // locate로 데이터 받아왔는데, 바보같이 굳이 useState, useEffect를 왜 씀???? 그냥 바로 쓰면 됨.
